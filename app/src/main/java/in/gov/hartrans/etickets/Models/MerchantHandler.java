...
public class MerchantHandler {
    ...
    //private static String merchantDomain = "beta.wibmo.com";
    ...
    public static WPayInitRequest generateMessageHash(WPayInitRequest req) throws Exception {
        ...
        postsb.append(URLEncoder.encode("merTxnID", "UTF-8"));
        postsb.append("=");
        postsb.append(URLEncoder.encode(req.getTransactionInfo().getMerTxnId(), "UTF-8"));
        postsb.append("&");
